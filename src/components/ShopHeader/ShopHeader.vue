<template>
  <div class="shop-header">
    <nav class="shop-nav" :style="info.bgImg?{backgroundImage:`url(${info.bgImg})`}:''">
...
.shop-header {
  ...
  .activity-sheet {
    ...
    &.tmde-enter-active, &.tmde-leave-active {
      transition: opacity 0.5s;
    }

    &.tmde-enter, &.tmde-leave-to {
      opacity: 0;
    }
